...
import com.easybus.Util.AStarAlgo;
import com.easybus.Util.BusFunction;
import com.easybus.Util.Constances;
import com.easybus.Util.ConvertUnsigned;
import com.easybus.gui.Activity.Instructions;
import com.easybus.gui.Activity.MainActivity;
import com.easybus.gui.Handler.FragmentCommunicator;
import com.easybus.gui.Object.Lines;
import com.easybus.gui.Object.Nodes;
import com.easybus.gui.Object.ResultObject;
...
//			if (alterBusStop.equals("Đầu B: ĐH Kinh tế Quốc dân"))
//				alterBusStop = "Đầu A: ĐH Kinh tế Quốc dân";
			//Check alter start
			check = 0;
			if(!isGo){
				for (int j = 0; j < goNodeTemp.size(); j++) {
